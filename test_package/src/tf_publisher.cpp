...
public:
    ...
    RobotTfPublisher(){
        ...
        modelstate.model_name = "feldschwarmRobot";
        modelstate.reference_frame = "world";
        setmodelstate.request.model_state = modelstate;

        // Get Gazebo state
        getmodelstate.request.model_name = "feldschwarmRobot";
...
int main(int argc, char** argv){
    ...
    ros::init(argc, argv, "robot_velodyne");
    
    RobotTfPublisher feldschwarmRobot;

    ROS_INFO("\033[1;32m---->\033[0m Gazebo TF publisher.");

    feldschwarmRobot.run();
